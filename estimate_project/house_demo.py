...
class HouseDemo(BuildingDemo):
    """
    A class to represent a house demolition project, inheriting from BuildingDemo.

    This class inherits all attributes and methods from the BuildingDemo class
    and can be used to calculate various costs associated with a house demolition
    project.
